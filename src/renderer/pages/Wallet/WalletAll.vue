      ...
      <div class="block w-full">
        ...
        >
          <div
            ...
            class="WalletAll__grid__wallet flex flex-col justify-center w-full overflow-hidden bg-theme-feature rounded-lg border-theme-wallet-overview-border border-b border-r mb-3"
          >
            <Loader />
          ...
          <div
            ...
            :key="wallet.id"
            class="WalletAll__grid__wallet w-full overflow-hidden bg-theme-feature rounded-lg border-theme-wallet-overview-border border-b border-r mb-3"
          >
            <div class="flex flex-row items-center">
              <RouterLink
